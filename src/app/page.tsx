	...
	return (
		<>
			...
			<Main>
				<div
					className={clsx(
						'relative flex w-full flex-col gap-[2rem]',
						'lg:w-[48%] lg:rounded-[1.8rem] lg:p-[1.6rem] lg:shadow-2xl',
						'xl:w-[40%]',
						{
							'lg:bg-lavender lg:bg-opacity-90': !darkMode,
							'lg:bg-ghostWhite lg:bg-opacity-20': darkMode,
						},
					)}
				>
				...
				<div className={clsx('relative hidden aspect-square w-[52%]', 'lg:block xl:w-[42%]', '2xl:w-[38%]')}>
					{darkMode ? (
						<Image src={'/bg-main-dark.svg'} alt="img" fill className={clsx('relative w-full object-cover')} />
					) : (
						<Image src={'/bg-main-light.svg'} alt="img" fill className={clsx('relative w-full object-cover')} />
					)}
				</div>
			</Main>
